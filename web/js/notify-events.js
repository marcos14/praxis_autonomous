...
export const GRUPOS_EVENTOS = [
  ...
  },
  {
    ...
    itens: [
      ...
      { tipo: "fase_falhou", rotulo: t("notif.ev_fase_falhou"), padrao: true, padrao_usuario: true },
      { tipo: "fase_nova", rotulo: t("notif.ev_fase_nova"), padrao: false },
      { tipo: "fase_pausada", rotulo: t("notif.ev_fase_pausada"), padrao: false },
      { tipo: "gates_falharam", rotulo: t("notif.ev_gates_falharam"), padrao: true, padrao_usuario: true },
      ...
      { tipo: "franquia_esgotada", rotulo: t("notif.ev_franquia_esgotada"), padrao: true, padrao_usuario: true },
  ...
  },
  {
    ...
    itens: [
      ...
      { tipo: "analise_concluida", rotulo: t("notif.ev_analise_concluida"), padrao: false, padrao_usuario: true },
      { tipo: "planejamento_iniciado", rotulo: t("notif.ev_planejamento_iniciado"), padrao: false },
      { tipo: "planejamento_concluido", rotulo: t("notif.ev_planejamento_concluido"), padrao: false, padrao_usuario: true },
  ...
  },
  {
    ...
    itens: [
      ...
      { tipo: "push_falhou", rotulo: t("notif.ev_push_falhou"), padrao: true, padrao_usuario: true },
      { tipo: "merge_falhou", rotulo: t("notif.ev_merge_falhou"), padrao: true, padrao_usuario: true },
    ],
  },
  {
    grupo: t("notif.grupo_consultas"),
    itens: [
      { tipo: "consulta_respondida", rotulo: t("notif.ev_consulta_respondida"), padrao: false, padrao_usuario: true },
      { tipo: "consulta_falhou", rotulo: t("notif.ev_consulta_falhou"), padrao: false, padrao_usuario: true },
      { tipo: "estrategia_respondida", rotulo: t("notif.ev_estrategia_respondida"), padrao: false, padrao_usuario: true },
      { tipo: "estrategia_falhou", rotulo: t("notif.ev_estrategia_falhou"), padrao: false, padrao_usuario: true },
