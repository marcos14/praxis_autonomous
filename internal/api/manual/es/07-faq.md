...
- **¿Se puede usar en el móvil / instalar como app?** Sí. Con Praxis en HTTPS válido, el navegador ofrece **Instalar app** (pie del menú; en iPhone, Compartir → Añadir a pantalla de inicio). En el móvil el menú queda tras ☰, las listas abren el elemento en su propia página (← vuelve) y el kanban muestra una columna a la vez. El IDE web solo en escritorio.
